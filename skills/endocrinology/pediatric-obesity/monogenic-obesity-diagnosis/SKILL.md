---
name: monogenic-obesity-diagnosis
description: >
  Diagnose monogenic and syndromic obesity in children and adolescents using a structured step-by-step algorithm.
  Use this skill whenever a clinician suspects a genetic cause of obesity, asks about leptin deficiency, MC4R mutation,
  POMC deficiency, PCSK1 deficiency, leptin receptor deficiency, Bardet-Biedl syndrome, Prader-Willi syndrome,
  Alström syndrome, or any case of early-onset severe obesity with hyperphagia. Also trigger for questions about
  targeted pharmacotherapy including setmelanotide or metreleptin, or when to order a genomic obesity panel.
  Cross-references the NHS Genomic Test Finder skill to surface the relevant R-code once a diagnosis is reached.
---
...
## Step 1 — Entry Criteria: Is This Case Atypical Enough to Pursue?
...
## Step 2 — Primary Branch: Is Developmental Delay or Intellectual Disability Present?
...
## Step 3A — Syndromic Obesity: Identify the Syndrome
...
## Step 3B — Monogenic Obesity: Work Through the Leptin-Melanocortin Pathway
...
### Leptin Deficiency (LEP mutation)
...
### Leptin Receptor Deficiency (LEPR mutation)
...
## Step 4 — Confirm with Genetic Testing
...
## Step 5 — Targeted Pharmacotherapy Summary
